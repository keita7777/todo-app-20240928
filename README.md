...
本来何かしらホーム画面を作る（もしくは TODO 一覧をホーム画面にする）べきだと思うが、今回は認証状態によってリダイレクトさせるようにしている
...
## フィルター、ソート、ページネーションなど、全体的に処理が重い
...
<br>
フィルター、ソート、ページネーションを使用するたびにローディングを表示させるみはどうすればよいでしょうか？
<br>
